...
public class LevelEight {
    ...
    static class FrameEight extends JFrame {
        public FrameEight() {
            setLayout(null);
    ...
    static class ComponentEight extends JComponent { // компонент с квадратами
    ...
    static class TimedRectangle extends Rectangle2D.Float { // расширенный квадрат
    ...
    static class RectangleMouse extends MouseMotionAdapter { // перехватчик движений мыши
