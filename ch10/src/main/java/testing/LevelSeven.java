...
public class LevelSeven {
    ...
    static class FrameSeven extends JFrame {
    ...
    static class ComponentSeven extends JComponent {
    ...
    static class PhotoAction extends AbstractAction { // класс-описание-перехватчик действия по смене фото
