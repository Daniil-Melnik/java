...
public class LevelSix {
    ...
    static class FrameSix extends JFrame {
    ...
    static class ComponentSix extends JComponent { // компонент с перетаскиваемым прямоугольником
    ...
    static class MotionMouse extends MouseMotionAdapter { // класс перехватчика основаный на адаптере
